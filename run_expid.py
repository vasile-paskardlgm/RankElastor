...
if __name__ == '__main__':
    ...
    if params["data_format"] == "csv":
        ...
        if 'criteo' in args['expid']:
            feature_encoder = FeatureProcessor(**params)
            params["train_data"], params["valid_data"], params["test_data"] = \
                build_dataset(feature_encoder, **params)
        elif 'avazu' in args['expid']:
            feature_encoder = CustomizedFeatureProcessor(**params)
            params["train_data"], params["valid_data"], params["test_data"] = \
                build_dataset(feature_encoder, **params)
        else:
            raise ValueError(f"Only Criteo and Avazu are supported in current version.")
    ...
    result_filename = Path(args['config']).name.replace(".yaml", "") + '_unimixer.csv'
